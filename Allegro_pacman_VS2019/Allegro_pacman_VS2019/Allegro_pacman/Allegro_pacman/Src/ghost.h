...
typedef enum {
	BLOCKED=0,		// stay inside the ghost room
	GO_OUT=1,		// going out the ghost room
	FREEDOM=2,		// free at the map
	GO_IN=3,		// going back to the ghost room 
	FLEE=4			// pacman powered up
} GhostStatus;
