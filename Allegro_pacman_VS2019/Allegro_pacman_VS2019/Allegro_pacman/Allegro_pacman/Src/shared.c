...
ALLEGRO_SAMPLE* gameBgm = NULL;
ALLEGRO_SAMPLE* settingBgm = NULL;
ALLEGRO_SAMPLE* winBgm = NULL;
ALLEGRO_SAMPLE* loseBgm = NULL;
ALLEGRO_SAMPLE* PACMAN_MOVESOUND = NULL;
ALLEGRO_SAMPLE* PACMAN_EATBEANSOUND = NULL;
ALLEGRO_SAMPLE* PACMAN_DEATH_SOUND = NULL;
ALLEGRO_FONT* menuFont = NULL;
int fontSize = 30;
float music_volume = 0.4;
float effect_volume = 0.6;
bool gameDone = false;
...
void shared_init(void) {
	...
	gameBgm = load_audio("Assets/Music/gameBgm.mp3");
	settingBgm = load_audio("Assets/Music/settingBgm.mp3");
	winBgm = load_audio("Assets/Music/pacman_intermission.ogg");
	loseBgm = load_audio("Assets/Music/loseBgm.mp3");
	PACMAN_MOVESOUND = load_audio("Assets/Music/pacman-chomp.ogg");
	PACMAN_EATBEANSOUND = load_audio("Assets/Music/pacman_eatfruit.ogg");
...
void shared_destroy(void) {
	...
	al_destroy_sample(gameBgm);
	al_destroy_sample(settingBgm);
