...
int main(void) {
    ...
    // TODO: [Initialize add-ons] (check下有冇嘢failed to initialize)
...
void game_draw(void) {
    ...
    // format : al_draw_rectangle(x1,y1,x2,y2,color, not important);
    ...
    // format : al_draw_test(font,color,x,y,flags,text,0);
    ...
    // format : al_draw_bitmap(image,x,y,0);
